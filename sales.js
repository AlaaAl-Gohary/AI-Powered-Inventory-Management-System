...
function buildProductOptions() {
    let options = '<option value="">-- Choose a prouduct --</option>';
    products.forEach(p => {
        options += `<option value="${p.productID}" data-price="${p.unitPrice}" data-stock="${p.stockQuantity}">${p.productName} (Available: ${p.stockQuantity})</option>`;
    });
    return options;
}
